...
module EsiClient
  class BookmarksApi
    ...
    def get_characters_character_id_bookmarks_with_http_info(character_id, opts = {})
      ...
      # resource path
      local_var_path = "/characters/{character_id}/bookmarks/".sub('{format}','json').sub('{' + 'character_id' + '}', character_id.to_s)
    ...
    def get_characters_character_id_bookmarks_folders_with_http_info(character_id, opts = {})
      ...
      # resource path
      local_var_path = "/characters/{character_id}/bookmarks/folders/".sub('{format}','json').sub('{' + 'character_id' + '}', character_id.to_s)
