...
module EsiClient
  ...
  class GetAlliancesAllianceIdOk
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'executor_corp')
        self.executor_corp = attributes[:'executor_corp']
      end
    ...
    def hash
      [alliance_name, date_founded, executor_corp, ticker].hash
    end
