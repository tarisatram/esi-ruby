...
module EsiClient
  ...
  class PutCorporationsCorporationIdStructuresStructureIdNewSchedule
    ...
    def list_invalid_properties
      ...
      if @day > 6
        invalid_properties.push("invalid value for 'day', must be smaller than or equal to 6.")
      end

      if @day < 0
        invalid_properties.push("invalid value for 'day', must be greater than or equal to 0.")
      end
    ...
    def day=(day)
      ...
      if day > 6
        fail ArgumentError, "invalid value for 'day', must be smaller than or equal to 6."
      end

      if day < 0
        fail ArgumentError, "invalid value for 'day', must be greater than or equal to 0."
      end
