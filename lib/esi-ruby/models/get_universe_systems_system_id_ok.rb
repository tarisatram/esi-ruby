...
module EsiClient
  ...
  class GetUniverseSystemsSystemIdOk
    ...
    def list_invalid_properties
      ...
      if @stargates.nil?
        invalid_properties.push("invalid value for 'stargates', stargates cannot be nil.")
      end
    ...
    def hash
      [constellation_id, name, planets, position, security_class, security_status, stargates, system_id].hash
    end
