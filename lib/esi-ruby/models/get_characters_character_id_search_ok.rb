...
module EsiClient
  ...
  class GetCharactersCharacterIdSearchOk
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'wormhole')
        if (value = attributes[:'wormhole']).is_a?(Array)
          self.wormhole = value
        end
      end
    ...
    def hash
      [agent, alliance, character, constellation, corporation, faction, inventorytype, region, solarsystem, station, structure, wormhole].hash
    end
