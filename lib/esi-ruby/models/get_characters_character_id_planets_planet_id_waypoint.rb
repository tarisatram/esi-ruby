...
module EsiClient
  ...
  class GetCharactersCharacterIdPlanetsPlanetIdWaypoint
    ...
    def list_invalid_properties
      ...
      if @order > 5
        invalid_properties.push("invalid value for 'order', must be smaller than or equal to 5.")
      end
    ...
    def order=(order)
      ...
      if order > 5
        fail ArgumentError, "invalid value for 'order', must be smaller than or equal to 5."
      end
