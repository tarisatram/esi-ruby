...
# Unit tests for EsiRuby::PlanetaryInteractionApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PlanetaryInteractionApi' do
  before do
    # run before each test
    @instance = EsiRuby::PlanetaryInteractionApi.new
  end
  ...
  describe 'test an instance of PlanetaryInteractionApi' do
    it 'should create an instact of PlanetaryInteractionApi' do
      expect(@instance).to be_instance_of(EsiRuby::PlanetaryInteractionApi)
    end
  end
