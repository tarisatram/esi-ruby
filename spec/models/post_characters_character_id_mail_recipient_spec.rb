...
# Unit tests for EsiRuby::PostCharactersCharacterIdMailRecipient
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PostCharactersCharacterIdMailRecipient' do
  before do
    # run before each test
    @instance = EsiRuby::PostCharactersCharacterIdMailRecipient.new
  end
  ...
  describe 'test an instance of PostCharactersCharacterIdMailRecipient' do
    it 'should create an instact of PostCharactersCharacterIdMailRecipient' do
      expect(@instance).to be_instance_of(EsiRuby::PostCharactersCharacterIdMailRecipient)
    end
  end
