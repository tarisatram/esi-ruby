...
# Unit tests for EsiRuby::PostFleetsFleetIdMembersInvitation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PostFleetsFleetIdMembersInvitation' do
  before do
    # run before each test
    @instance = EsiRuby::PostFleetsFleetIdMembersInvitation.new
  end
  ...
  describe 'test an instance of PostFleetsFleetIdMembersInvitation' do
    it 'should create an instact of PostFleetsFleetIdMembersInvitation' do
      expect(@instance).to be_instance_of(EsiRuby::PostFleetsFleetIdMembersInvitation)
    end
  end
