...
# Unit tests for EsiRuby::GetCharactersCharacterIdPlanets200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdPlanets200Ok' do
  before do
    # run before each test
    @instance = EsiRuby::GetCharactersCharacterIdPlanets200Ok.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdPlanets200Ok' do
    it 'should create an instact of GetCharactersCharacterIdPlanets200Ok' do
      expect(@instance).to be_instance_of(EsiRuby::GetCharactersCharacterIdPlanets200Ok)
    end
  end
