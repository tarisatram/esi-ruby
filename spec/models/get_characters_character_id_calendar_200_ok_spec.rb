...
# Unit tests for EsiRuby::GetCharactersCharacterIdCalendar200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdCalendar200Ok' do
  before do
    # run before each test
    @instance = EsiRuby::GetCharactersCharacterIdCalendar200Ok.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdCalendar200Ok' do
    it 'should create an instact of GetCharactersCharacterIdCalendar200Ok' do
      expect(@instance).to be_instance_of(EsiRuby::GetCharactersCharacterIdCalendar200Ok)
    end
  end
