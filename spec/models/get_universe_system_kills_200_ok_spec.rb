...
# Unit tests for EsiRuby::GetUniverseSystemKills200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetUniverseSystemKills200Ok' do
  before do
    # run before each test
    @instance = EsiRuby::GetUniverseSystemKills200Ok.new
  end
  ...
  describe 'test an instance of GetUniverseSystemKills200Ok' do
    it 'should create an instact of GetUniverseSystemKills200Ok' do
      expect(@instance).to be_instance_of(EsiRuby::GetUniverseSystemKills200Ok)
    end
  end
