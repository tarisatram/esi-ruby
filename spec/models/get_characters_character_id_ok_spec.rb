...
# Unit tests for EsiRuby::GetCharactersCharacterIdOk
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdOk' do
  before do
    # run before each test
    @instance = EsiRuby::GetCharactersCharacterIdOk.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdOk' do
    it 'should create an instact of GetCharactersCharacterIdOk' do
      expect(@instance).to be_instance_of(EsiRuby::GetCharactersCharacterIdOk)
    end
  end
