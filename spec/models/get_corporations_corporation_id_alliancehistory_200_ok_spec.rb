...
# Unit tests for EsiRuby::GetCorporationsCorporationIdAlliancehistory200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCorporationsCorporationIdAlliancehistory200Ok' do
  before do
    # run before each test
    @instance = EsiRuby::GetCorporationsCorporationIdAlliancehistory200Ok.new
  end
  ...
  describe 'test an instance of GetCorporationsCorporationIdAlliancehistory200Ok' do
    it 'should create an instact of GetCorporationsCorporationIdAlliancehistory200Ok' do
      expect(@instance).to be_instance_of(EsiRuby::GetCorporationsCorporationIdAlliancehistory200Ok)
    end
  end
