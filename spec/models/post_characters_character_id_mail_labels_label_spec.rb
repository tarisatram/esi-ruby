...
# Unit tests for EsiRuby::PostCharactersCharacterIdMailLabelsLabel
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PostCharactersCharacterIdMailLabelsLabel' do
  before do
    # run before each test
    @instance = EsiRuby::PostCharactersCharacterIdMailLabelsLabel.new
  end
  ...
  describe 'test an instance of PostCharactersCharacterIdMailLabelsLabel' do
    it 'should create an instact of PostCharactersCharacterIdMailLabelsLabel' do
      expect(@instance).to be_instance_of(EsiRuby::PostCharactersCharacterIdMailLabelsLabel)
    end
  end
