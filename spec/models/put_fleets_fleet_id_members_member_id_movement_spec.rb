...
# Unit tests for EsiRuby::PutFleetsFleetIdMembersMemberIdMovement
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PutFleetsFleetIdMembersMemberIdMovement' do
  before do
    # run before each test
    @instance = EsiRuby::PutFleetsFleetIdMembersMemberIdMovement.new
  end
  ...
  describe 'test an instance of PutFleetsFleetIdMembersMemberIdMovement' do
    it 'should create an instact of PutFleetsFleetIdMembersMemberIdMovement' do
      expect(@instance).to be_instance_of(EsiRuby::PutFleetsFleetIdMembersMemberIdMovement)
    end
  end
