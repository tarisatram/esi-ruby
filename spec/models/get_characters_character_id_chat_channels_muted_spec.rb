...
# Unit tests for EsiRuby::GetCharactersCharacterIdChatChannelsMuted
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdChatChannelsMuted' do
  before do
    # run before each test
    @instance = EsiRuby::GetCharactersCharacterIdChatChannelsMuted.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdChatChannelsMuted' do
    it 'should create an instact of GetCharactersCharacterIdChatChannelsMuted' do
      expect(@instance).to be_instance_of(EsiRuby::GetCharactersCharacterIdChatChannelsMuted)
    end
  end
