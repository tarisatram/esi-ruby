...
# Unit tests for EsiRuby::GetWarsWarIdDefender
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetWarsWarIdDefender' do
  before do
    # run before each test
    @instance = EsiRuby::GetWarsWarIdDefender.new
  end
  ...
  describe 'test an instance of GetWarsWarIdDefender' do
    it 'should create an instact of GetWarsWarIdDefender' do
      expect(@instance).to be_instance_of(EsiRuby::GetWarsWarIdDefender)
    end
  end
