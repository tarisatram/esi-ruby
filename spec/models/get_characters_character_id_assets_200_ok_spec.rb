...
# Unit tests for EsiRuby::GetCharactersCharacterIdAssets200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdAssets200Ok' do
  before do
    # run before each test
    @instance = EsiRuby::GetCharactersCharacterIdAssets200Ok.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdAssets200Ok' do
    it 'should create an instact of GetCharactersCharacterIdAssets200Ok' do
      expect(@instance).to be_instance_of(EsiRuby::GetCharactersCharacterIdAssets200Ok)
    end
  end
