...
# Unit tests for EsiRuby::GetCharactersCharacterIdClonesHomeLocation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdClonesHomeLocation' do
  before do
    # run before each test
    @instance = EsiRuby::GetCharactersCharacterIdClonesHomeLocation.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdClonesHomeLocation' do
    it 'should create an instact of GetCharactersCharacterIdClonesHomeLocation' do
      expect(@instance).to be_instance_of(EsiRuby::GetCharactersCharacterIdClonesHomeLocation)
    end
  end
