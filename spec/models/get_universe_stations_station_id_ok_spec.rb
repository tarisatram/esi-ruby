...
# Unit tests for EsiRuby::GetUniverseStationsStationIdOk
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetUniverseStationsStationIdOk' do
  before do
    # run before each test
    @instance = EsiRuby::GetUniverseStationsStationIdOk.new
  end
  ...
  describe 'test an instance of GetUniverseStationsStationIdOk' do
    it 'should create an instact of GetUniverseStationsStationIdOk' do
      expect(@instance).to be_instance_of(EsiRuby::GetUniverseStationsStationIdOk)
    end
  end
