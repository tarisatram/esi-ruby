...
# Unit tests for EsiRuby::GetCharactersCharacterIdChatChannelsOperator
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdChatChannelsOperator' do
  before do
    # run before each test
    @instance = EsiRuby::GetCharactersCharacterIdChatChannelsOperator.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdChatChannelsOperator' do
    it 'should create an instact of GetCharactersCharacterIdChatChannelsOperator' do
      expect(@instance).to be_instance_of(EsiRuby::GetCharactersCharacterIdChatChannelsOperator)
    end
  end
