...
# Unit tests for EsiRuby::GetFleetsFleetIdMembers200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetFleetsFleetIdMembers200Ok' do
  before do
    # run before each test
    @instance = EsiRuby::GetFleetsFleetIdMembers200Ok.new
  end
  ...
  describe 'test an instance of GetFleetsFleetIdMembers200Ok' do
    it 'should create an instact of GetFleetsFleetIdMembers200Ok' do
      expect(@instance).to be_instance_of(EsiRuby::GetFleetsFleetIdMembers200Ok)
    end
  end
