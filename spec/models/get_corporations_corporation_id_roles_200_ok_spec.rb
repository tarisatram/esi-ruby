...
# Unit tests for EsiRuby::GetCorporationsCorporationIdRoles200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCorporationsCorporationIdRoles200Ok' do
  before do
    # run before each test
    @instance = EsiRuby::GetCorporationsCorporationIdRoles200Ok.new
  end
  ...
  describe 'test an instance of GetCorporationsCorporationIdRoles200Ok' do
    it 'should create an instact of GetCorporationsCorporationIdRoles200Ok' do
      expect(@instance).to be_instance_of(EsiRuby::GetCorporationsCorporationIdRoles200Ok)
    end
  end
