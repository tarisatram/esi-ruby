...
# Unit tests for EsiRuby::PostCharactersAffiliation200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PostCharactersAffiliation200Ok' do
  before do
    # run before each test
    @instance = EsiRuby::PostCharactersAffiliation200Ok.new
  end
  ...
  describe 'test an instance of PostCharactersAffiliation200Ok' do
    it 'should create an instact of PostCharactersAffiliation200Ok' do
      expect(@instance).to be_instance_of(EsiRuby::PostCharactersAffiliation200Ok)
    end
  end
