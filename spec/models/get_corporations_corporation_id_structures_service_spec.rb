...
# Unit tests for EsiRuby::GetCorporationsCorporationIdStructuresService
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCorporationsCorporationIdStructuresService' do
  before do
    # run before each test
    @instance = EsiRuby::GetCorporationsCorporationIdStructuresService.new
  end
  ...
  describe 'test an instance of GetCorporationsCorporationIdStructuresService' do
    it 'should create an instact of GetCorporationsCorporationIdStructuresService' do
      expect(@instance).to be_instance_of(EsiRuby::GetCorporationsCorporationIdStructuresService)
    end
  end
