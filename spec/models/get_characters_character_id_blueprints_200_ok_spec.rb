...
# Unit tests for EsiRuby::GetCharactersCharacterIdBlueprints200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdBlueprints200Ok' do
  before do
    # run before each test
    @instance = EsiRuby::GetCharactersCharacterIdBlueprints200Ok.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdBlueprints200Ok' do
    it 'should create an instact of GetCharactersCharacterIdBlueprints200Ok' do
      expect(@instance).to be_instance_of(EsiRuby::GetCharactersCharacterIdBlueprints200Ok)
    end
  end
